...
<html>
    ...
    <body style="background-image: url('ppr.jpg');">
        ...
        <div style="-moz-user-select: none; -webkit-user-select:none; -ms-user-select:none; user-select:none; -moz-user-drag:none; -webkit-user-drag:none; -ms-user-drag:none; user-drag: none;" unselectable="on">
            <h2>Welcome to PHP Tic Tac Toe game.</h2>
            <?php
    ...
    function game_message($message) {
        ...
        switch ($message) {
            case 'invalid-size':
                ...
                echo 'Either fix the game board size variable values in the URL or Start a new game by clicking on the option below.';
                break;
            case 'invalid-board':
                ...
                echo 'Either fix the game board variable values in the URL or Start a new game by clicking on the option below.';
                break;
            ...
            case 'new-game':
                ...
                echo 'ATTENTION: if you want to change the game board size, click on one of the options(s) below:<br />';
                echo '<i>These option(s) are only available during a new game (before any boxes are marked).</i><br /><br />';
                if ($this->grid_size > 3) {
